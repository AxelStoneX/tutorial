 ...
 *
 *  This module represents the main module for the PCL-711 driver.
 *
 *  This program will act as the front-end to the PCL-711 (digital/analog I/O board).
 *
...
//  resmgr_attr.msg_max_size = 2048;
    ...
    for (i = 0; i < npcl711; i++) {
        if (resmgr_attach (dpp, &resmgr_attr, pcl711 [i].name, _FTYPE_ANY, 0, &connect_func, &io_func, &pcl711 [i]) == -1) {
...
optproc (int argc, char **argv)
{
    ...
    if (npcl711 == 0) {         // nothing added by user, add the default one then
