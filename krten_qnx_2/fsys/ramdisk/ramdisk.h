...
int             ramdisk_io_read_dir (resmgr_context_t *ctp, io_read_t *msg, iofunc_ocb_t *ocb);
int             ramdisk_io_read_file (resmgr_context_t *ctp, io_read_t *msg, iofunc_ocb_t *ocb);
int             ramdisk_io_write (resmgr_context_t *ctp, io_write_t *msg, RESMGR_OCB_T *ocb);
